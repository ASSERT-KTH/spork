 ...
 * @author Simon Larsén
 */
internal class ContentResolver : Function<SpoonNode, RoledValues> {
    /**
     ...
     */
    override fun apply(node: SpoonNode): RoledValues {
        return getContent(node.element)
    }
    ...
    companion object {
         ...
         * @return The content of the node.
         */
        fun getContent(elem: CtElement): RoledValues {
            ...
            } else if (elem is CtBinaryOperator<*> || elem is CtUnaryOperator<*> || elem is CtOperatorAssignment<*, *>) {
            ...
            if (elem is CtComment) {
                ...
                val content = RoledValue(CtRole.COMMENT_CONTENT, elem.getValueByRole<Any>(CtRole.COMMENT_CONTENT))
