 ...
 * @since 1.2
 */
public class ArrayList<E> extends AbstractList<E> implements Serializable , Cloneable , List<E> , RandomAccess {
    @Serial
    ...
    private Object[] grow(int minCapacity) {
        ...
        if ((oldCapacity > 0) || (elementData != DEFAULTCAPACITY_EMPTY_ELEMENTDATA)) {
            int newCapacity = /* minimum growth */
                    /* preferred growth */
     ...
     * @serial_data The length of the array backing the {@code ArrayList}
